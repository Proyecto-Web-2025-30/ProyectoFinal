...
public class UserController {
    ...
    public ResponseEntity<?> createUser(@PathVariable Long companyId, @Valid @RequestBody CreateUserRequest request) {
        try {
    ...
    @GetMapping
    public ResponseEntity<List<AppUser>> getUsersByCompanyParam(@RequestParam("companyId") Long companyId) {
        return ResponseEntity.ok(userService.getUsersByCompany(companyId));
    }
}
